...
public class AddRoom extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(500, 180, 153, 56);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("Enter Room No:");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(380, 310, 100, 17);
        getContentPane().add(RoomNo);
        RoomNo.setBounds(610, 300, 140, 30);
        ...
        jLabel3.setBounds(0, 0, 1500, 720);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ps=conn.prepareStatement("insert into room(Room_No,Booking) values(?,'Unbooked')");
            ps.setInt(1, RNO);
            ps.executeUpdate();
